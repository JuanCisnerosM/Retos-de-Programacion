...
public class AccessModifiersExercises {
    ...
    public static void main(String[] args) {
        ...
        Person3 miPersona = new Person3();
        miPersona.setName("JOJO");
        miPersona.setAge(89);
        System.out.println("El nombre es: " + miPersona.getName() + " y su edad es de: " + miPersona.getAge());

        Person3 miPersona2 = new Person3("DIO", 189);
        ...
        Book miLibro = new Book("L.O.T.R");
        System.out.println(miLibro.getTitle());
        ...
        miRectangle.setHeight(10);
        miRectangle.setWidth(10);
